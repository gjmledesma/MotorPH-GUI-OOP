 ...
 */
public class SalaryTaxCalculatorService implements SalaryTaxCalculatorDAO {
    ...
    @Override
    public double calculateWithholdingTax(double basicSalary, double sss, double philhealth, double pagibig) {
