...
public class HRPayroll extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hrpayslipButton = new javax.swing.JButton();
        ...
        hrpayslipButton.setText("Open HRPayslip");
        hrpayslipButton.addActionListener(evt -> openFrame(new HRPayslip()));
        hrdashboardButton.setText("Open HRDashboard");
        hrdashboardButton.addActionListener(evt -> openFrame(new HRDashboard()));
        buttonPanel.add(hrpayslipButton);
    ...
    private javax.swing.JButton hrpayslipButton;
